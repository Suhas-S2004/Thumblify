...
import { ArrowRightIcon, DownloadIcon, Link, TrashIcon } from "lucide-react"
    ...
    <>
      ...
      <div className="mt-32 min-h-screen px-6 md:px-16 lg:px-24 xl:px-32">
        ...
        <div key={thumb._id} onClick={() => navigate(`/generate/${thumb._id}`)}
          ...
          <div className="absolute bottom-2 right-2 max-sm:flex sm:hidden group-hover:flex gap-1.5" onClick={(e) => e.stopPropagation()}>
