        ...
        <>
            ...
            >
                ...
                <div className="hidden md:flex items-center gap-8 transition duration-500">
                    ...
                    <Link to='/my-generation' className="hover:text-pink-300 transition">My Generations
                    </Link>

                    : 
                     <Link to='#' className="hover:text-pink-300 transition">About
                    </Link>


                    }
                    <Link to='#' className="hover:text-pink-300 transition">Contact Us
                    </Link>
                </div>
